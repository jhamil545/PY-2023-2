...
import 'package:asistencia_app/bloc/pasto/pasto_bloc.dart';
...
class PastoForm extends StatefulWidget {
  @override
  _PastoFormState createState() => _PastoFormState();
}

class _PastoFormState extends State<PastoForm> {
  late String _nombrePasto = "";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Form. Reg. Pasto B"),
          ...
          child: Container(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    _buildDatoCadena(capturaNombreAct, "Nombre Pasto:"),
                    Padding(
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                ...
                                PastoModelo mp = new PastoModelo.unlaunched();
                                mp.area = _nombrePasto;
                                //print(DateFormat('yyyy-MM-dd').format(currentTime));

                                print("NA:${_nombrePasto}");

                                /*var api = await Provider.of<PastoApi>(
                                    context,
                                    listen: false)
                                    .crearPasto(TokenUtil.TOKEN,mp);
                                ...
                                BlocProvider.of<PastoBloc>(context)
                                    .add(CreatePastoEvent(mp));
                                Navigator.pop(context, () {
                                  //setState(() {});
                                });
                              } else {
