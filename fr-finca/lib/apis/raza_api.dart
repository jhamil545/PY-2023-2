...
abstract class RazaApi {
  ...
  Future<RazaModelo> crearRaza(
      @Header("Authorization") String token, @Body() RazaModelo raza);
  ...
  Future<RazaModelo> updateRaza(@Header("Authorization") String token,
      @Path("id") int id, @Body() RazaModelo raza);
}
